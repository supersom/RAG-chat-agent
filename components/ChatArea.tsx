      ...
      {showAvatar && (
        <>
          <Avatar className="w-10 h-10 border">
            <AvatarFallback className="bg-primary text-primary-foreground font-semibold text-xs">SB</AvatarFallback>
          </Avatar>
          <div>
        ...
        >
          ...
          <div className="flex justify-between items-center p-3">
            <div className="text-xs text-muted-foreground mt-1">
              Powered by <span className="font-semibold text-foreground" style={{ fontFamily: "inherit", letterSpacing: "-0.01em" }}>LiteLLM</span>
            </div>
            <Button
              type="submit"
